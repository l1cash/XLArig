...
rapidjson::Value xlarig::Hashrate::toJSON(rapidjson::Document &doc) const
{
    using namespace rapidjson;
...
rapidjson::Value xlarig::Hashrate::toJSON(size_t threadId, rapidjson::Document &doc) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
