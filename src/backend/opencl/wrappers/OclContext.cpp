...
xlarig::OclContext::OclContext(const OclDevice &device)
{
...
bool xlarig::OclContext::init(const std::vector<OclDevice> &devices, std::vector<OclLaunchData> &threads)
{
    if (!m_ctx) {
