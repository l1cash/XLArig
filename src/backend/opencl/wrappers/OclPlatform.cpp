...
std::vector<xlarig::OclPlatform> xlarig::OclPlatform::get()
{
...
rapidjson::Value xlarig::OclPlatform::toJSON(rapidjson::Document &doc) const
{
...
std::vector<xlarig::OclDevice> xlarig::OclPlatform::devices() const
{
...
xlarig::String xlarig::OclPlatform::extensions() const
{
    return OclLib::getString(id(), CL_PLATFORM_EXTENSIONS);
}


xlarig::String xlarig::OclPlatform::name() const
{
    return OclLib::getString(id(), CL_PLATFORM_NAME);
}


xlarig::String xlarig::OclPlatform::profile() const
{
    return OclLib::getString(id(), CL_PLATFORM_PROFILE);
}


xlarig::String xlarig::OclPlatform::vendor() const
{
    return OclLib::getString(id(), CL_PLATFORM_VENDOR);
}


xlarig::String xlarig::OclPlatform::version() const
{
