...
xlarig::OclCnRunner::OclCnRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
xlarig::OclCnRunner::~OclCnRunner()
{
    delete m_cn0;
    delete m_cn1;
    delete m_cn2;
...
size_t xlarig::OclCnRunner::bufferSize() const
{
...
void xlarig::OclCnRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void xlarig::OclCnRunner::set(const Job &job, uint8_t *blob)
{
