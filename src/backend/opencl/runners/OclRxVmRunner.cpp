...
xlarig::OclRxVmRunner::OclRxVmRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


xlarig::OclRxVmRunner::~OclRxVmRunner()
{
    delete m_init_vm;
    delete m_execute_vm;
...
size_t xlarig::OclRxVmRunner::bufferSize() const
{
    return OclRxBaseRunner::bufferSize() + (align(2560 * m_intensity));
}


void xlarig::OclRxVmRunner::build()
{
...
void xlarig::OclRxVmRunner::execute(uint32_t iteration)
{
...
void xlarig::OclRxVmRunner::init()
{
