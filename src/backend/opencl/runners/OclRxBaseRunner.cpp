...
xlarig::OclRxBaseRunner::OclRxBaseRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
xlarig::OclRxBaseRunner::~OclRxBaseRunner()
{
...
void xlarig::OclRxBaseRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void xlarig::OclRxBaseRunner::set(const Job &job, uint8_t *blob)
{
...
size_t xlarig::OclRxBaseRunner::bufferSize() const
{
...
void xlarig::OclRxBaseRunner::build()
{
    OclBaseRunner::build();
...
void xlarig::OclRxBaseRunner::init()
{
    OclBaseRunner::init();
