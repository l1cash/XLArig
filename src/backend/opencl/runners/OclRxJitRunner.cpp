...
xlarig::OclRxJitRunner::OclRxJitRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


xlarig::OclRxJitRunner::~OclRxJitRunner()
{
...
void xlarig::OclRxJitRunner::execute(uint32_t iteration)
{
...
void xlarig::OclRxJitRunner::init()
{
...
bool xlarig::OclRxJitRunner::loadAsmProgram()
{
