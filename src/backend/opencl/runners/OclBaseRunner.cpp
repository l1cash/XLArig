...
xlarig::OclBaseRunner::OclBaseRunner(size_t id, const OclLaunchData &data) :
...
xlarig::OclBaseRunner::~OclBaseRunner()
{
...
size_t xlarig::OclBaseRunner::bufferSize() const
{
    return align(Job::kMaxBlobSize) + align(sizeof(cl_uint) * 0x100);
}


uint32_t xlarig::OclBaseRunner::deviceIndex() const
{
    return data().thread.index();
}


void xlarig::OclBaseRunner::build()
{
...
void xlarig::OclBaseRunner::init()
{
...
cl_mem xlarig::OclBaseRunner::createSubBuffer(cl_mem_flags flags, size_t size)
{
...
size_t xlarig::OclBaseRunner::align(size_t size) const
{
    return VirtualMemory::align(size, m_align);
}


void xlarig::OclBaseRunner::enqueueReadBuffer(cl_mem buffer, cl_bool blocking_read, size_t offset, size_t size, void *ptr)
{
...
void xlarig::OclBaseRunner::enqueueWriteBuffer(cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void *ptr)
{
...
void xlarig::OclBaseRunner::finalize(uint32_t *hashOutput)
{
