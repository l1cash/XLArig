...
xlarig::Algorithm::Id xlarig::Coin::algorithm(uint8_t blobVersion) const
{
    if (id() == MONERO) {
...
const char *xlarig::Coin::name() const
{
...
rapidjson::Value xlarig::Coin::toJSON() const
{
...
xlarig::Coin::Id xlarig::Coin::parse(const char *name)
{
