...
void xlarig::ConsoleLog::print(int, const char *line, size_t, size_t size, bool colors)
{
...
bool xlarig::ConsoleLog::isSupported() const
{
...
bool xlarig::ConsoleLog::isWritable() const
{
