...
#define LOG_EMERG(x, ...)  xlarig::Log::print(xlarig::Log::EMERG,   x, ##__VA_ARGS__)
#define LOG_ALERT(x, ...)  xlarig::Log::print(xlarig::Log::ALERT,   x, ##__VA_ARGS__)
#define LOG_CRIT(x, ...)   xlarig::Log::print(xlarig::Log::CRIT,    x, ##__VA_ARGS__)
#define LOG_ERR(x, ...)    xlarig::Log::print(xlarig::Log::ERR,     x, ##__VA_ARGS__)
#define LOG_WARN(x, ...)   xlarig::Log::print(xlarig::Log::WARNING, x, ##__VA_ARGS__)
#define LOG_NOTICE(x, ...) xlarig::Log::print(xlarig::Log::NOTICE,  x, ##__VA_ARGS__)
#define LOG_INFO(x, ...)   xlarig::Log::print(xlarig::Log::INFO,    x, ##__VA_ARGS__)

#ifdef APP_DEBUG
#   define LOG_DEBUG(x, ...) xlarig::Log::print(xlarig::Log::DEBUG, x, ##__VA_ARGS__)
#else
#   define LOG_DEBUG(x, ...)
#endif

#if defined(APP_DEBUG) || defined(APP_DEVEL)
#   define LOG_DEBUG_ERR(x, ...)  xlarig::Log::print(xlarig::Log::ERR,     x, ##__VA_ARGS__)
#   define LOG_DEBUG_WARN(x, ...) xlarig::Log::print(xlarig::Log::WARNING, x, ##__VA_ARGS__)
#else
